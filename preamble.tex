...
\documentclass[13pt,cjk,color=usenames]{beamer}
...
\usepackage{CJK,ccmap,times,listings}
\usepackage{pgf,tikz,pgflibraryshapes,pgflibrarytikztrees,pgflibraryarrows}
