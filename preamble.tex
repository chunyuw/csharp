...
%\documentclass[a4paper]{article}  \usepackage[noxcolor]{beamerarticle}

\mode<handout>{                 % print only handout
  \RequirePackage{ifthen}
  \newboolean{handoutprint}\setboolean{handoutprint}{true}} % false
