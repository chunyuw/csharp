...
\documentclass[13pt,xcolor=svgnames,table,xetex]{beamer}
%\documentclass[a4paper]{article}
%\usepackage[noxcolor]{beamerarticle}

\author[\textsf{chunyu@hit.edu.cn}]{王春宇}
\mode<presentation>{\institute[哈尔滨工业大学]{计算机科学与技术学院\\软件基础教研室}}
\date{} % {2013年9月3日}  {2012年8月28日}  {2011年8月22日}  {2010年9月2日}
        % {2009年8月31日} {2008年10月28日} {2007年10月30日} {2006年7月13日}

\mode<handout>{%
  \RequirePackage{ifthen}       %
  \newboolean{handoutprint}\setboolean{handoutprint}{false}} % true: 白色背景
...
\lstdefinelanguage{CSharp}{%
  morekeywords={abstract, as, base, break, case, catch, checked, class,
    ...
    unchecked, unsafe, using, value, virtual, volatile, where, while, into,
    async, await},
