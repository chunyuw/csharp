...
\documentclass[13pt,xcolor=svgnames,table,xetex]{beamer} % Line: 3
%\documentclass[a4paper]{article}                        % Line: 4
%\usepackage[noxcolor]{beamerarticle}                    % Line: 5

\author[\textsf{chunyu@hit.edu.cn}]{王春宇}
\mode<presentation>{\institute[哈尔滨工业大学]{计算机科学与技术学院\\软件基础教研室}}
\date{} % {2011年8月22日}
% {2010年9月2日} {2009年8月31日} {2008年10月28日} {2007年10月30日} {2006年7月13日}

\mode<handout>{%
  \RequirePackage{ifthen}       %
  \newboolean{handoutprint}     % true: 白色背景
  \setboolean{handoutprint}{false}}                      % Line: 16
