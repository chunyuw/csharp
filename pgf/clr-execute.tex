...
\foreach \x/\y in {1/y1,2/y2,3/y3,4/y4} \draw (3,2) +(.75cm,3.6cm-.8cm*\x) node (\y) {Method \x};
...
\foreach \x/\y in {1/z1,2/z2} \draw (6,2) +(.75cm,2cm-.8cm*\x) node (\y)  {Method \x};
...
\draw<4>[->] (jit.east) .. controls +(right:3cm) and +(right:1cm)
