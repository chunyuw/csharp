...
\begin{frame}[fragile]
\frametitle{使用~\texttt{lock} 简化~Monitor}
\begin{itemize}
...
\begin{itemize}
\item C\# 2.0 新增的 ~Semaphore 类，用于限制访问临界资源的线程数
...
\begin{itemize}
\item 静态类~Interlocked 为多个线程共享的变量提供原子操作
...
\frametitle{线程池的使用}
\begin{itemize}
\item 线程池线程 ~IsThreadPooThread 为 true
\end{itemize}
