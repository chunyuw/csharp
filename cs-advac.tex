...
\begin{lstlisting}
Shape x = new Recangle();
x.Area(); // x可以直接访问Area()方法
\end{lstlisting}
...
class Program
{
  public delegate void HandlerMethods(Dogs d);
 
  public static void FirstMethod(Animals elephant)
    {...}
  public static void SecondMethod(Dogs sheepdogs)
    {...}
 
  static void Main()
    {
      HandlerMethods handler1 = FirstMethiod;
      HandlerMethods handler2 = SecondMethod;
    }
}
\end{lstlisting}
\end{frame}
